...
$c501_sun_end = "SELECT id, end_time FROM cecs501 WHERE checker_sun = 0";
...
$c502_sun_end = "SELECT id, end_time FROM cecs502 WHERE checker_sun = 0";
...
$h502_sun_end = "SELECT id, end_time FROM heb502 WHERE checker_sun = 0";
...
$eldc2_sun_end = "SELECT id, end_time FROM ldc304 WHERE checker_sun = 0";
...
// check for conflicting schedules! (WORKING)
...
<div class = "homepage_border">
  ...
  <!--button for add new lec-->
  <div class="container_of_newlec">
    <a href = "addlect_fsem.php">ADD NEW</a>
  </div>
...
if (!empty($selected_lec_name)) {
    $count_units = "SELECT COUNT(name_id) AS lecturer_count FROM lecturers WHERE name_id = ?";  
...
$stmt->close(); 
    ...
    //full time
    if ($checkerpos == 2) {
        if ($lecturer_count >= 30) {
        echo'echo <div class="load_count">';
        echo "<br><br>Lecturer Units: $lecturer_count";
        echo'</div>';
        echo '
        <div class="excess_message">
            <br>Maximum Load Reached! To add more, proceed to Excess Load!<br>
        </div>';
        echo '<div class="addex_message">
            <a href="addexcessloadsem1.php">ADD NEW</a>
        </div>';
        echo '<div class="giveex_message">
            <a href="giveexcessload1.php">GIVE EXCESS LOAD</a>
        </div>';
        return;
}
    else{
