                ...
                if (insertData($conn, $selected_lec_name, $selected_section_id, $selected_subject_id, $selected_room_id, $selected_day_id, $selected_sTime_id, $selected_eTime_id)) {
                    ...
                    if (!$update_checker_stmt) {
                        ...
                        if ($update_checker_stmt->execute()) {
                            echo "<div class='success_message'><p>Schedule has been Found!</p></div>";
                        } else {
...
<div class = "homepage_border">
  ...
  <div class="container_of_newlec">
    <a href = "addlect_ssem.php">ADD NEW</a>
  </div>
...
$stmt->close(); 
    ...
    if ($checkerpos == 2) {
        ...
        echo '<div class="addex_message">
            <a href="addexcessloadsem2.php">ADD NEW</a>
        </div>';
        echo '<div class="giveex_message">
            <a href="giveexcessload2.php">GIVE EXCESS LOAD</a>
        </div>';
        return;
}
    else{
