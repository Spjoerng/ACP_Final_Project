...
function eTimeDropdown($lec_eTime_result, $selected_eTime_id) {
    ...
    echo "
        <div class='container_of_modify'>
            <a href='addloadsem1.php' style='background:none; border:none; cursor:pointer; display:inline-block;'>
                <img src='modify.png' style='width: 30px; height: 30px;'>
            </a>
            <a href='addloadsem1.php' style='background:none; border:none; cursor:pointer; color:inherit; font:inherit; text-decoration:none; display:inline-block;'>
                Modify
            </a>
        </div>";
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && $selected_lec_name) {
        ...
        if ($stmt->execute()) {
            ...
            if ($result->num_rows > 0) {
                ...
                echo "
                    <div class='no_sched'>
                        <p>No schedule available for this lecturer.</p>
                    </div>";
                return;
            }
        } else {
