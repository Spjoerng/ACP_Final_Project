...
//CECS 501
$c501_mon_start = "SELECT id, start_time FROM cecs501";
$c501_mon_start_result = $conn->query($c501_mon_start);
$c501_mon_end = "SELECT id, end_time FROM cecs501 ";
$c501_mon_end_result = $conn->query($c501_mon_end);

$c501_tue_start = "SELECT id, start_time FROM cecs501";
$c501_tue_start_result = $conn->query($c501_tue_start);
$c501_tue_end = "SELECT id, end_time FROM cecs501";
$c501_tue_end_result = $conn->query($c501_tue_end);

$c501_wed_start = "SELECT id, start_time FROM cecs501";
$c501_wed_start_result = $conn->query($c501_wed_start);
$c501_wed_end = "SELECT id, end_time FROM cecs501";
$c501_wed_end_result = $conn->query($c501_wed_end);

$c501_thu_start = "SELECT id, start_time FROM cecs501";
$c501_thu_start_result = $conn->query($c501_thu_start);
$c501_thu_end = "SELECT id, end_time FROM cecs501";
$c501_thu_end_result = $conn->query($c501_thu_end);

$c501_fri_start = "SELECT id, start_time FROM cecs501";
$c501_fri_start_result = $conn->query($c501_fri_start);
$c501_fri_end = "SELECT id, end_time FROM cecs501";
$c501_fri_end_result = $conn->query($c501_fri_end);

$c501_sat_start = "SELECT id, start_time FROM cecs501";
$c501_sat_start_result = $conn->query($c501_sat_start);
$c501_sat_end = "SELECT id, end_time FROM cecs501";
$c501_sat_end_result = $conn->query($c501_sat_end);

$c501_sun_start = "SELECT id, start_time FROM cecs501";
$c501_sun_start_result = $conn->query($c501_sun_start);
$c501_sun_end = "SELECT id, end_time FROM cecs501";
$c501_sun_end_result = $conn->query($c501_sun_end);

//CECS 502
$c502_mon_start = "SELECT id, start_time FROM cecs502";
$c502_mon_start_result = $conn->query($c502_mon_start);
$c502_mon_end = "SELECT id, end_time FROM cecs502";
$c502_mon_end_result = $conn->query($c502_mon_end);

$c502_tue_start = "SELECT id, start_time FROM cecs502";
$c502_tue_start_result = $conn->query($c502_tue_start);
$c502_tue_end = "SELECT id, end_time FROM cecs502";
$c502_tue_end_result = $conn->query($c502_tue_end);

$c502_wed_start = "SELECT id, start_time FROM cecs502";
$c502_wed_start_result = $conn->query($c502_wed_start);
$c502_wed_end = "SELECT id, end_time FROM cecs502";
$c502_wed_end_result = $conn->query($c502_wed_end);

$c502_thu_start = "SELECT id, start_time FROM cecs502";
$c502_thu_start_result = $conn->query($c502_thu_start);
$c502_thu_end = "SELECT id, end_time FROM cecs502";
$c502_thu_end_result = $conn->query($c502_thu_end);

$c502_fri_start = "SELECT id, start_time FROM cecs502";
$c502_fri_start_result = $conn->query($c502_fri_start);
$c502_fri_end = "SELECT id, end_time FROM cecs502";
$c502_fri_end_result = $conn->query($c502_fri_end);

$c502_sat_start = "SELECT id, start_time FROM cecs502";
$c502_sat_start_result = $conn->query($c502_sat_start);
$c502_sat_end = "SELECT id, end_time FROM cecs502";
$c502_sat_end_result = $conn->query($c502_sat_end);

$c502_sun_start = "SELECT id, start_time FROM cecs502";
$c502_sun_start_result = $conn->query($c502_sun_start);
$c502_sun_end = "SELECT id, end_time FROM cecs502";
$c502_sun_end_result = $conn->query($c502_sun_end);


//CECS 503
$c503_mon_start = "SELECT id, start_time FROM cecs503";
$c503_mon_start_result = $conn->query($c503_mon_start);
$c503_mon_end = "SELECT id, end_time FROM cecs503";
$c503_mon_end_result = $conn->query($c503_mon_end);

$c503_tue_start = "SELECT id, start_time FROM cecs503";
$c503_tue_start_result = $conn->query($c503_tue_start);
$c503_tue_end = "SELECT id, end_time FROM cecs503";
$c503_tue_end_result = $conn->query($c503_tue_end);

$c503_wed_start = "SELECT id, start_time FROM cecs503";
$c503_wed_start_result = $conn->query($c503_wed_start);
$c503_wed_end = "SELECT id, end_time FROM cecs503";
$c503_wed_end_result = $conn->query($c503_wed_end);

$c503_thu_start = "SELECT id, start_time FROM cecs503";
$c503_thu_start_result = $conn->query($c503_thu_start);
$c503_thu_end = "SELECT id, end_time FROM cecs503";
$c503_thu_end_result = $conn->query($c503_thu_end);

$c503_fri_start = "SELECT id, start_time FROM cecs503";
$c503_fri_start_result = $conn->query($c503_fri_start);
$c503_fri_end = "SELECT id, end_time FROM cecs503";
$c503_fri_end_result = $conn->query($c503_fri_end);

$c503_sat_start = "SELECT id, start_time FROM cecs503";
$c503_sat_start_result = $conn->query($c503_sat_start);
$c503_sat_end = "SELECT id, end_time FROM cecs503";
$c503_sat_end_result = $conn->query($c503_sat_end);

$c503_sun_start = "SELECT id, start_time FROM cecs503";
$c503_sun_start_result = $conn->query($c503_sun_start);
$c503_sun_end = "SELECT id, end_time FROM cecs503";
$c503_sun_end_result = $conn->query($c503_sun_end);


//HEB 502
$h502_mon_start = "SELECT id, start_time FROM heb502";
$h502_mon_start_result = $conn->query($h502_mon_start);
$h502_mon_end = "SELECT id, end_time FROM heb502";
$h502_mon_end_result = $conn->query($h502_mon_end);

$h502_tue_start = "SELECT id, start_time FROM heb502";
$h502_tue_start_result = $conn->query($h502_tue_start);
$h502_tue_end = "SELECT id, end_time FROM heb502";
$h502_tue_end_result = $conn->query($h502_tue_end);

$h502_wed_start = "SELECT id, start_time FROM heb502";
$h502_wed_start_result = $conn->query($h502_wed_start);
$h502_wed_end = "SELECT id, end_time FROM heb502";
$h502_wed_end_result = $conn->query($h502_wed_end);

$h502_thu_start = "SELECT id, start_time FROM heb502";
$h502_thu_start_result = $conn->query($h502_thu_start);
$h502_thu_end = "SELECT id, end_time FROM heb502";
$h502_thu_end_result = $conn->query($h502_thu_end);

$h502_fri_start = "SELECT id, start_time FROM heb502";
$h502_fri_start_result = $conn->query($h502_fri_start);
$h502_fri_end = "SELECT id, end_time FROM heb502";
$h502_fri_end_result = $conn->query($h502_fri_end);

$h502_sat_start = "SELECT id, start_time FROM heb502";
$h502_sat_start_result = $conn->query($h502_sat_start);
$h502_sat_end = "SELECT id, end_time FROM heb502";
$h502_sat_end_result = $conn->query($h502_sat_end);

$h502_sun_start = "SELECT id, start_time FROM heb502";
$h502_sun_start_result = $conn->query($h502_sun_start);
$h502_sun_end = "SELECT id, end_time FROM heb502";
$h502_sun_end_result = $conn->query($h502_sun_end);


//ABB 101
$a101_mon_start = "SELECT id, start_time FROM abb101";
$a101_mon_start_result = $conn->query($a101_mon_start);
$a101_mon_end = "SELECT id, end_time FROM abb101";
$a101_mon_end_result = $conn->query($a101_mon_end);

$a101_tue_start = "SELECT id, start_time FROM abb101";
$a101_tue_start_result = $conn->query($a101_tue_start);
$a101_tue_end = "SELECT id, end_time FROM abb101";
$a101_tue_end_result = $conn->query($a101_tue_end);

$a101_wed_start = "SELECT id, start_time FROM abb101";
$a101_wed_start_result = $conn->query($a101_wed_start);
$a101_wed_end = "SELECT id, end_time FROM abb101";
$a101_wed_end_result = $conn->query($a101_wed_end);

$a101_thu_start = "SELECT id, start_time FROM abb101";
$a101_thu_start_result = $conn->query($a101_thu_start);
$a101_thu_end = "SELECT id, end_time FROM abb101";
$a101_thu_end_result = $conn->query($a101_thu_end);

$a101_fri_start = "SELECT id, start_time FROM abb101";
$a101_fri_start_result = $conn->query($a101_fri_start);
$a101_fri_end = "SELECT id, end_time FROM abb101";
$a101_fri_end_result = $conn->query($a101_fri_end);

$a101_sat_start = "SELECT id, start_time FROM abb101";
$a101_sat_start_result = $conn->query($a101_sat_start);
$a101_sat_end = "SELECT id, end_time FROM abb101";
$a101_sat_end_result = $conn->query($a101_sat_end);

$a101_sun_start = "SELECT id, start_time FROM abb101";
$a101_sun_start_result = $conn->query($a101_sun_start);
$a101_sun_end = "SELECT id, end_time FROM abb101";
$a101_sun_end_result = $conn->query($a101_sun_end);


//ABB 103
$a103_mon_start = "SELECT id, start_time FROM abb103";
$a103_mon_start_result = $conn->query($a103_mon_start);
$a103_mon_end = "SELECT id, end_time FROM abb103";
$a103_mon_end_result = $conn->query($a103_mon_end);

$a103_tue_start = "SELECT id, start_time FROM abb103";
$a103_tue_start_result = $conn->query($a103_tue_start);
$a103_tue_end = "SELECT id, end_time FROM abb103";
$a103_tue_end_result = $conn->query($a103_tue_end);

$a103_wed_start = "SELECT id, start_time FROM abb103";
$a103_wed_start_result = $conn->query($a103_wed_start);
$a103_wed_end = "SELECT id, end_time FROM abb103";
$a103_wed_end_result = $conn->query($a103_wed_end);

$a103_thu_start = "SELECT id, start_time FROM abb103";
$a103_thu_start_result = $conn->query($a103_thu_start);
$a103_thu_end = "SELECT id, end_time FROM abb103";
$a103_thu_end_result = $conn->query($a103_thu_end);

$a103_fri_start = "SELECT id, start_time FROM abb103";
$a103_fri_start_result = $conn->query($a103_fri_start);
$a103_fri_end = "SELECT id, end_time FROM abb103";
$a103_fri_end_result = $conn->query($a103_fri_end);

$a103_sat_start = "SELECT id, start_time FROM abb103";
$a103_sat_start_result = $conn->query($a103_sat_start);
$a103_sat_end = "SELECT id, end_time FROM abb103";
$a103_sat_end_result = $conn->query($a103_sat_end);

$a103_sun_start = "SELECT id, start_time FROM abb103";
$a103_sun_start_result = $conn->query($a103_sun_start);
$a103_sun_end = "SELECT id, end_time FROM abb103";
$a103_sun_end_result = $conn->query($a103_sun_end);

//LDC 304
$l304_mon_start = "SELECT id, start_time FROM ldc304";
$l304_mon_start_result = $conn->query($l304_mon_start);
$l304_mon_end = "SELECT id, end_time FROM ldc304";
$l304_mon_end_result = $conn->query($l304_mon_end);

$l304_tue_start = "SELECT id, start_time FROM ldc304";
$l304_tue_start_result = $conn->query($l304_tue_start);
$l304_tue_end = "SELECT id, end_time FROM ldc304";
$l304_tue_end_result = $conn->query($l304_tue_end);

$l304_wed_start = "SELECT id, start_time FROM ldc304";
$l304_wed_start_result = $conn->query($l304_wed_start);
$l304_wed_end = "SELECT id, end_time FROM ldc304";
$l304_wed_end_result = $conn->query($l304_wed_end);

$l304_thu_start = "SELECT id, start_time FROM ldc304";
$l304_thu_start_result = $conn->query($l304_thu_start);
$l304_thu_end = "SELECT id, end_time FROM ldc304";
$l304_thu_end_result = $conn->query($l304_thu_end);

$l304_fri_start = "SELECT id, start_time FROM ldc304";
$l304_fri_start_result = $conn->query($l304_fri_start);
$l304_fri_end = "SELECT id, end_time FROM ldc304";
$l304_fri_end_result = $conn->query($l304_fri_end);

$l304_sat_start = "SELECT id, start_time FROM ldc304 ";
$l304_sat_start_result = $conn->query($l304_sat_start);
$l304_sat_end = "SELECT id, end_time FROM ldc304 ";
$l304_sat_end_result = $conn->query($l304_sat_end);

$l304_sun_start = "SELECT id, start_time FROM ldc304 ";
$l304_sun_start_result = $conn->query($l304_sun_start);
$l304_sun_end = "SELECT id, end_time FROM ldc304 ";
$l304_sun_end_result = $conn->query($l304_sun_end);

//LDC 305
$l305_mon_start = "SELECT id, start_time FROM ldc305";
$l305_mon_start_result = $conn->query($l305_mon_start);
$l305_mon_end = "SELECT id, end_time FROM ldc305";
$l305_mon_end_result = $conn->query($l305_mon_end);

$l305_tue_start = "SELECT id, start_time FROM ldc305";
$l305_tue_start_result = $conn->query($l305_tue_start);
$l305_tue_end = "SELECT id, end_time FROM ldc305";
$l305_tue_end_result = $conn->query($l305_tue_end);

$l305_wed_start = "SELECT id, start_time FROM ldc305";
$l305_wed_start_result = $conn->query($l305_wed_start);
$l305_wed_end = "SELECT id, end_time FROM ldc305";
$l305_wed_end_result = $conn->query($l305_wed_end);

$l305_thu_start = "SELECT id, start_time FROM ldc305";
$l305_thu_start_result = $conn->query($l305_thu_start);
$l305_thu_end = "SELECT id, end_time FROM ldc305";
$l305_thu_end_result = $conn->query($l305_thu_end);

$l305_fri_start = "SELECT id, start_time FROM ldc305";
$l305_fri_start_result = $conn->query($l305_fri_start);
$l305_fri_end = "SELECT id, end_time FROM ldc305";
$l305_fri_end_result = $conn->query($l305_fri_end);

$l305_sat_start = "SELECT id, start_time FROM ldc305";
$l305_sat_start_result = $conn->query($l305_sat_start);
$l305_sat_end = "SELECT id, end_time FROM ldc305";
$l305_sat_end_result = $conn->query($l305_sat_end);

$l305_sun_start = "SELECT id, start_time FROM ldc305";
$l305_sun_start_result = $conn->query($l305_sun_start);
$l305_sun_end = "SELECT id, end_time FROM ldc305";
$l305_sun_end_result = $conn->query($l305_sun_end);

//ELDC 2
$eldc2_mon_start = "SELECT id, start_time FROM eldc2";
$eldc2_mon_start_result = $conn->query($eldc2_mon_start);
$eldc2_mon_end = "SELECT id, end_time FROM eldc2";
$eldc2_mon_end_result = $conn->query($eldc2_mon_end);

$eldc2_tue_start = "SELECT id, start_time FROM eldc2";
$eldc2_tue_start_result = $conn->query($eldc2_tue_start);
$eldc2_tue_end = "SELECT id, end_time FROM eldc2";
$eldc2_tue_end_result = $conn->query($l304_tue_end);

$eldc2_wed_start = "SELECT id, start_time FROM ldc304";
$eldc2_wed_start_result = $conn->query($l304_wed_start);
$eldc2_wed_end = "SELECT id, end_time FROM ldc304";
$eldc2_wed_end_result = $conn->query($l304_wed_end);

$eldc2_thu_start = "SELECT id, start_time FROM ldc304";
$eldc2_thu_start_result = $conn->query($l304_thu_start);
$eldc2_thu_end = "SELECT id, end_time FROM ldc304";
$eldc2_thu_end_result = $conn->query($l304_thu_end);

$eldc2_fri_start = "SELECT id, start_time FROM ldc304";
$eldc2_fri_start_result = $conn->query($l304_fri_start);
$eldc2_fri_end = "SELECT id, end_time FROM ldc3043";
$eldc2_fri_end_result = $conn->query($l304_fri_end);

$eldc2_sat_start = "SELECT id, start_time FROM ldc304";
$eldc2_sat_start_result = $conn->query($l304_sat_start);
$eldc2_sat_end = "SELECT id, end_time FROM ldc304";
$eldc2_sat_end_result = $conn->query($l304_sat_end);

$eldc2_sun_start = "SELECT id, start_time FROM ldc304";
$eldc2_sun_start_result = $conn->query($l304_sun_start);
$eldc2_sun_end = "SELECT id, end_time FROM ldc304";
$eldc2_sun_end_result = $conn->query($l304_sun_end);

//HEC 302
$h302_mon_start = "SELECT id, start_time FROM hec302";
$h302_mon_start_result = $conn->query($h302_mon_start);
$h302_mon_end = "SELECT id, end_time FROM hec302";
$h302_mon_end_result = $conn->query($h302_mon_end);

$h302_tue_start = "SELECT id, start_time FROM hec302";
$h302_tue_start_result = $conn->query($h302_tue_start);
$h302_tue_end = "SELECT id, end_time FROM hec302";
$h302_tue_end_result = $conn->query($h302_tue_end);

$h302_wed_start = "SELECT id, start_time FROM hec302";
$h302_wed_start_result = $conn->query($h302_wed_start);
$h302_wed_end = "SELECT id, end_time FROM hec302";
$h302_wed_end_result = $conn->query($h302_wed_end);

$h302_thu_start = "SELECT id, start_time FROM hec302";
$h302_thu_start_result = $conn->query($h302_thu_start);
$h302_thu_end = "SELECT id, end_time FROM hec302";
$h302_thu_end_result = $conn->query($h302_thu_end);

$h302_fri_start = "SELECT id, start_time FROM hec302";
$h302_fri_start_result = $conn->query($h302_fri_start);
$h302_fri_end = "SELECT id, end_time FROM hec302";
$h302_fri_end_result = $conn->query($h302_fri_end);

$h302_sat_start = "SELECT id, start_time FROM hec302";
$h302_sat_start_result = $conn->query($h302_sat_start);
$h302_sat_end = "SELECT id, end_time FROM hec302";
$h302_sat_end_result = $conn->query($h302_sat_end);

$h302_sun_start = "SELECT id, start_time FROM hec302 ";
$h302_sun_start_result = $conn->query($h302_sun_start);
$h302_sun_end = "SELECT id, end_time FROM hec302";
$h302_sun_end_result = $conn->query($h302_sun_end);

//PHYSICS
$phy_mon_start = "SELECT id, start_time FROM phylab";
$phy_mon_start_result = $conn->query($phy_mon_start);
$phy_mon_end = "SELECT id, end_time FROM phylab";
$phy_mon_end_result = $conn->query($phy_mon_end);

$phy_tue_start = "SELECT id, start_time FROM phylab";
$phy_tue_start_result = $conn->query($phy_tue_start);
$phy_tue_end = "SELECT id, end_time FROM phylab";
$phy_tue_end_result = $conn->query($phy_tue_end);

$phy_wed_start = "SELECT id, start_time FROM phylab";
$phy_wed_start_result = $conn->query($phy_wed_start);
$phy_wed_end = "SELECT id, end_time FROM phylab";
$phy_wed_end_result = $conn->query($phy_wed_end);

$phy_thu_start = "SELECT id, start_time FROM phylab";
$phy_thu_start_result = $conn->query($phy_thu_start);
$phy_thu_end = "SELECT id, end_time FROM phylab";
$phy_thu_end_result = $conn->query($phy_thu_end);

$phy_fri_start = "SELECT id, start_time FROM phylab";
$phy_fri_start_result = $conn->query($phy_fri_start);
$phy_fri_end = "SELECT id, end_time FROM phylab";
$phy_fri_end_result = $conn->query($phy_fri_end);

$phy_sat_start = "SELECT id, start_time FROM phylab";
$phy_sat_start_result = $conn->query($phy_sat_start);
$phy_sat_end = "SELECT id, end_time FROM phylab";
$phy_sat_end_result = $conn->query($phy_sat_end);

$phy_sun_start = "SELECT id, start_time FROM phylab";
$phy_sun_start_result = $conn->query($phy_sun_start);
$phy_sun_end = "SELECT id, end_time FROM phylab";
...
function deleteData($conn, $name_id, $section_id, $subject_id, $room_id, $day_id, $sTime_id, $eTime_id) {
    ...
    if (checkConflict($conn, $section_id, $day_id, $room_id,  $sTime_id, $eTime_id)) {
    ...
    echo "
        <div class='container_of_modify'>
            <a href='addloadsem2.php' style='background:none; border:none; cursor:pointer; display:inline-block;'>
                <img src='modify.png' style='width: 30px; height: 30px;'>
            </a>
...
function saveButton(){
    echo '<form action="addloadsem3.php" method="POST" style="display: inline;">
...
function selectTime($conn, $startResult, $endResult, $selected_sTime_id, $selected_eTime_id,  $selected_subject_id, $selected_lec_name, $selected_section_id, $selected_room_id, $selected_day_id, $firstchecker, $secondchecker){
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $restricted_subject_ids = [2, 11, 20, 32];
...
<div class = "homepage_border">
  ...
  <div class="container_of_back_button">
    ...
    <a href="menu_third_sem.html">Back</a>
  </div>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && $selected_lec_name) {
        ...
        if ($stmt->execute()) {
            ...
            if ($result->num_rows > 0) {
                ...
                echo"<div class ='enter_details'>";
                echo"<p>Enter Details Here</p>";
                echo"</div>";
