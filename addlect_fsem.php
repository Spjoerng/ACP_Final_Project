...
<head>
  ...
  <link rel="stylesheet" href="addlect.css">
</head>
<body>
...
<div class = "homepage_border">
  ...
  <div class="info">
    ...
    <form action="" method="post">
        <div class="lecturer">
        <label for="lecturer_name">Lecturer Name:</label></div>
        <div class="input_lec">
        <input type="text" id="lecturer_name" name="lecturer_name" required><br></div>
        <div class="format">
        <label for="example">LASTNAME, FIRSTNAME, MI. (Ex. DELA CRUZ, JUAN A.)</label><br></div>
